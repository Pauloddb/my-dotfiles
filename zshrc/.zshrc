...
export JS_PATH="$CODE_PATH/javascript"
export TS_PATH="$CODE_PATH/typescript"
export GO_PATH="$CODE_PATH/go"
export PY_PATH="$CODE_PATH/python"
export RUST_PATH="$CODE_PATH/rust"
export QS_PATH="$CODE_PATH/quickshell"
export AGS_PATH="$CODE_PATH/ags"
